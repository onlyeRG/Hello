...
class LinkChanger:
    ...
    def set_client(self, client):
        """Set the bot client for logging"""
        self.client = client
...
link_changer = LinkChanger()
            for attempt in range(max_attempts):
                try:
                    ...
                    if self.client:
                        await logger.log_link_change(self.client, channel_id, base_username, new_username, 'success')
                    ...
                    if "USERNAME_OCCUPIED" in str(e) or "occupied" in str(e).lower():
                        ...
                        if self.client:
                            await logger.log_error(self.client, "LinkChangeError", 0, str(e))
